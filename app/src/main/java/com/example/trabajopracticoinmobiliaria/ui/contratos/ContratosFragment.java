...
public class ContratosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new InmuebleAdapter(this::navegarADetalleContrato);
        binding.recyclerContratos.setLayoutManager(new LinearLayoutManager(requireContext()));
    ...
    private void navegarADetalleContrato(@NonNull Inmueble inmueble) {
        Bundle args = new Bundle();
        args.putSerializable(DetalleContratoViewModel.ARG_INMUEBLE, inmueble);
        Navigation.findNavController(requireView())
                .navigate(R.id.action_contratos_to_detalle_contrato, args);
    }
