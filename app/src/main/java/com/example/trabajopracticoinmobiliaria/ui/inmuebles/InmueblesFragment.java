...
public class InmueblesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new InmuebleAdapter(this::navegarADetalle);
        binding.recyclerInmuebles.setLayoutManager(new LinearLayoutManager(requireContext()));
        binding.recyclerInmuebles.setAdapter(adapter);

        binding.swipeRefresh.setOnRefreshListener(() -> vm.cargarInmuebles());

        binding.fabAgregarInmueble.setOnClickListener(v ->
                Navigation.findNavController(v).navigate(R.id.action_inmuebles_to_cargar_inmueble));

        vm.getInmuebles().observe(getViewLifecycleOwner(), this::mostrarInmuebles);
    ...
    private void navegarADetalle(@NonNull Inmueble inmueble) {
        Bundle args = new Bundle();
        args.putSerializable(DetalleInmuebleViewModel.ARG_INMUEBLE, inmueble);
        Navigation.findNavController(requireView())
                .navigate(R.id.action_inmuebles_to_detalle_inmueble, args);
    }
