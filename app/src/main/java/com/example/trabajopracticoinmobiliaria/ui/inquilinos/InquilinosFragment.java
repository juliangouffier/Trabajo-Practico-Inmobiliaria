...
public class InquilinosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        InquilinosViewModel modelo = new ViewModelProvider(
                this,
                new InquilinosViewModel.Factory(getString(R.string.feature_in_development)))
                .get(InquilinosViewModel.class);
